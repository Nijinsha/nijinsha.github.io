...
IOWA.CountdownTimer.Core.prototype.addSeparators = function() {
    ...
    for (var e = 0; e < this.separators.length; e++) t.clearRect(this.separators[e].x - 2, this.separators[e].y - 2, this.separators[e].w + 4, this.separators[e].h + 4), t.beginPath(), t.moveTo(this.separators[e].x, this.separators[e].y), t.lineTo(this.separators[e].x + this.separators[e].w, this.separators[e].y + this.separators[e].h), t.lineWidth = this.strokeWeight, t.strokeStyle = "#38003c", t.lineCap = "round", t.stroke();
    t.restore()
};
